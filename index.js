...
const UUID = process.env.UUID || 'f90415f3-64bd-4a09-8475-e976356b95a3'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'zxy.tszxy.de5.net';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNjFhZDM5NGY0N2NhODU5MDc3ZjQ5MWY3ZDMxNzRlNzQiLCJ0IjoiMTdiMjllNWMtODA2OS00OGY5LTliZDQtMDVjMTVlMjNmYTJmIiwicyI6Ik0yUXdaVFEzTlRndE9ESm1aUzAwWVRjNExXSmtZelV0WVRGbU0yRTRNek13WWpFMSJ9
...
const NAME = process.env.NAME || 'zxy';                        // 节点名称
